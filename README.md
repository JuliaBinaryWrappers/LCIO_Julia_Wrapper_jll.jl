# `LCIO_Julia_Wrapper_jll.jl` (v0.13.3+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8d36fc089f6ee5d8e5d6f1a4ca4b3bf40011d538/L/LCIO_Julia_Wrapper/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaHEP/LCIO_Julia_Wrapper.git (revision: `e28132bfdc0664faf9724a74b2ae33803c26dc5a`)
